...
static inline void __GetRoot( LPCTSTR path_name, GString& root_string )
{
...
GString GFile::GetFileName( void ) const
{
...
GString GFile::GetFilePath( void ) const
{
...
GString GFile::GetFileTitle( void ) const
{
		  ...
		  m_PathName.GetLength() > 0 )
	{
		...
		{
			const_cast< GString& >( m_FileTitle ) = file_title;
		}
		else
		{
			const_cast< GString& >( m_FileTitle ).Empty();
		}
	}
